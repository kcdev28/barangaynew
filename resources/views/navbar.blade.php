    ...
    <nav class="navbar navbar-expand-xl px-5">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link navbar-link {{ request()->routeIs('landingPage') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link navbar-link {{ request()->routeIs('aboutUsPage') ? 'active' : '' }}"
                        href="{{ route('aboutUsPage') }}">
                        ABOUT
                    </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ route('BarangayClearancePage') }}">Barangay Clearance</a></li>
                        <li><a class="dropdown-item" href="{{ route('ResidencyPage') }}">Certificate of Residency</a></li>
                        <li><a class="dropdown-item" href="{{ route('IndigencyPage') }}">Certificate of Indigency</a></li>
                        <li><a class="dropdown-item" href="{{ route('FirstTimeJobSeekerPage') }}">First Time Job Seeker</a></li>
                        <li><a class="dropdown-item" href="{{ route('BusinessPermitPage') }}">Business Permit</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('newsandeventPage') ? 'active' : '' }}"
                        href="{{ route('newsandeventPage') }}">
                        NEWS & EVENTS
                    </a>
